...
class ThemeManager {
    constructor() {
        ...
        this.moonIcon = this.toggleBtn ? this.toggleBtn.querySelector('.moon-icon') : null;
        this.sunIcon = this.toggleBtn ? this.toggleBtn.querySelector('.sun-icon') : null;
    ...
    applyTheme(theme) {
        ...
        if (this.moonIcon && this.sunIcon) {
            if (theme === 'dark') {
                ...
                this.toggleBtn.setAttribute('aria-label', 'Cambiar a modo claro');
            } else {
                this.moonIcon.style.display = 'block';
                this.sunIcon.style.display = 'none';
                this.toggleBtn.setAttribute('aria-label', 'Cambiar a modo oscuro');
            }
        }
    }
}
...
function initHeaderScroll() {
    ...
    window.addEventListener('scroll', () => {
        ...
        if (scrollTop > 100) {
            header.style.backgroundColor = 'var(--bg-header-scrolled)';
